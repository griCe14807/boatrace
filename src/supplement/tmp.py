...
def _190505_add_space_to_simulation_result_kumibann():
    simulation_result_file = r"/Users/grice/mywork/boatrace/data/boatRace/simulation/simulation_results_csv/2t/20190503_2t_simulationResult.csv"
...
def _delete_a_column():
    simulation_result_file = r"/Users/grice/mywork/boatrace/data/boatRace/simulation/simulation_results_csv/3t/20190502_3t_simulationResult.csv"
    simulation_result_df = pd.read_csv(simulation_result_file)
